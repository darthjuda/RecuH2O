...
#define chargePin      D4         // on utilise le pin 13 pour charger le condensateur - connected to one end of the charging resistor
#define dischargePin   D9         // on utilise le pin 11 pour décharger le condensateur
      ...
      if (client.available()) { // s'il y a des bits a lire provenant du client
        ...
        if (c == '\n') { //  si le bit est une nouvelle ligne de caractere
          ...
          if (currentLine.length() == 0) {
            ...
            client.println(".dot { background-color: #12c412; border: 2px solid black; border-radius: 5px; color: black;}");
            client.println(".dot { background-color: #ff7b00; border: 2px solid black; border-radius: 5px; color: black;}");
            client.println(".dot { background-color: #ff0000; border: 2px solid black; border-radius: 5px; color: black;}</style></head>");
            ...
            switch (niveauCuve) {
              case 0 ...3:
                client.println("<p><span class=\"dot\">Bas</span></p>");
                break;
